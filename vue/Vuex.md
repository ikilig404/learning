...
![单向数据流](https://v3.vuex.vuejs.org/flow.png)
...
![vuex原理图](https://v3.vuex.vuejs.org/vuex.png)
...
为了处理异步操作，让我们来看一看 [Action](https://v3.vuex.vuejs.org/zh/guide/actions.html)。
...
##### 4.5.2.1 在带命名空间的模块内访问全局内容（Global Assets）
...
##### 5.5.4.3 使用 Karma + karma-webpack 在浏览器中执行测试
